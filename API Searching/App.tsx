  ...
  return(
    <View style={styles.main}>
      ...
      <View style={styles.input1}>
        <TextInput style={styles.input2} onChangeText={(text)=>openWeb4(text)}></TextInput>
        <TouchableHighlight style={styles.text1a}>
          <Text style={{marginTop:"auto",marginBottom:"auto"}}>Search Google</Text>
        </TouchableHighlight>
        <View style={{flex:1}}>
        {
          data.length ?
